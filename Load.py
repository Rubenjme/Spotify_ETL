#------------------------------------------------------------------------------------------
# Este script se encarga de cargar los datos transformados en una base de datos PostgreSQL.
#------------------------------------------------------------------------------------------
...
DB_HOST = os.getenv("POSTGRES_HOST", "localhost") # Host de la base de datos 
